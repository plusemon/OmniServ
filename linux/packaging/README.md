...
- deb/      → debian control + rules, builds omniserv_<ver>_amd64.deb (apt install ./file.deb)
- appimage/ → AppDir + appimagetool recipe, builds OmniServ-<ver>.AppImage (download & run)
