...
public sealed partial class SettingsPage : Page
{
    ...
    private void Load()
    {
        ...
        PhpDefBox.SelectedIndex = Math.Max(0, Array.IndexOf(OmniServ.Core.Services.PhpVersions, cfg.DefaultPhp));
        ...
        Version.Text = $"OmniServ for Windows · {Updater.CurrentVersion}";
    ...
    private async void CheckUpdates_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Title = $"OmniServ {r.Latest} available",
