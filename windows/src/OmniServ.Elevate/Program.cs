...
// omniserv-elevate — runs elevated (requireAdministrator). Does ONLY the admin-only
// steps so the main CLI/GUI can stay unprivileged. Invoked via runas by Core.Elevation.
//   omniserv-elevate hosts-add <domain>
//   omniserv-elevate hosts-remove <domain>
//   omniserv-elevate mkcert-install
