...
/// <summary>
/// Add OmniServ's folders to Windows Defender's exclusion list so the antivirus doesn't quarantine the
/// server binaries OmniServ downloads (PHP/nginx/MariaDB/redis/memcached…). Defender-only — there's no
