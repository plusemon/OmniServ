...
/// <summary>
/// Resolves managed binaries from OmniServ's own portable installs — in two roots:
/// (1) the user's <c>%LOCALAPPDATA%\OmniServ\bin\</c> (on-demand downloads/updates), and
...
/// antivirus behavioral scanners from flagging omniserv.exe as a "dropper".
/// OmniServ never borrows binaries from Laragon/XAMPP/etc.
/// </summary>
