...
/// <summary>
/// Bridges the unprivileged CLI/GUI to <c>omniserv-elevate.exe</c> for the few
...
{
    /// <summary>Locate omniserv-elevate.exe (next to the running exe, or the published layout).</summary>
    public static string? HelperPath()
    {
        var dir = AppContext.BaseDirectory;
        foreach (var name in new[] { "omniserv-elevate.exe", "OmniServ.Elevate.exe" })
        {
