...
public static class Apache
{
    ...
    public static void RenderMain()
    {
        ...
        sb.Append($$"""
        # Generated by OmniServ (Windows) — Apache backend behind nginx. Do not edit by hand.
        ServerRoot "{{Fwd(root)}}"
        ...
        <VirtualHost 127.0.0.1:{{Port}}>
            ...
            <Location "/">
                Require all denied
                ErrorDocument 403 "<!doctype html><meta charset='utf-8'><title>OmniServ</title><p style='font:15px sans-serif;margin:3em'>This site is switching web servers - refresh in a moment.</p>"
            </Location>
        </VirtualHost>
    ...
    public static void RenderVhost(string name, string domain, string root, string phpKey, Config cfg)
    {
        ...
        Directory.CreateDirectory(SitesDir);
        var body = $$"""
        # OmniServ Apache backend: {{name}} ({{domain}}) php={{phpKey}}
        <VirtualHost 127.0.0.1:{{Port}}>
            ServerName {{domain}}
