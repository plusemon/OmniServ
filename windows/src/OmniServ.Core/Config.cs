...
/// <summary>
/// Typed view of <c>config\omniserv.json</c> — the Windows analog of the mac
...
public sealed class Config
{
    ...
    [JsonPropertyName("sites_root")]   public string SitesRoot { get; set; } =
        System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "OmniServ", "www");
