...
public static class NginxConfig
{
    ...
    public static void RenderMain(Config cfg)
    {
        ...
        sb.Append($$"""
        # Generated by OmniServ (Windows) — do not edit by hand (regenerated on init / site changes).
    ...
    private static string ListenBlock(string domain, Config cfg)
    {
        ...
        {
            sb.AppendLine($"    # HTTPS not provisioned — run: omniserv secure {domain}");
        }
    ...
    public static void RenderPhpVhost(string name, string domain, string root, string phpKey, Config cfg, IEnumerable<string>? aliases = null)
    {
        ...
        var body = $$"""
        # OmniServ site: {{name}}  ({{domain}})  php={{phpKey}} server=nginx
        server {
    ...
    public static void RenderApacheFront(string name, string domain, string root, string phpKey, int apachePort, Config cfg, IEnumerable<string>? aliases = null)
    {
        ...
        var conf = Path.Combine(Paths.NginxSites, $"{name}.conf");
        var body = $$"""
        # OmniServ site: {{name}}  ({{domain}})  php={{phpKey}} server=apache
        server {
        {{ListenBlock(domain, cfg)}}
            server_name {{ServerNames(domain, aliases)}};
