    ...
    var body: some View {
        ...
        VStack(spacing: 22) {
            VStack(spacing: 8) {
                ...
                Text("Welcome to OmniServ").font(.largeTitle.bold())
            ...
            VStack(alignment: .leading, spacing: 16) {
                SetupStep(number: 1, title: "Homebrew",
                          ...
                          detail: state.brewInstalled
                            ? "Installed — OmniServ uses it to manage every service."
                            : "OmniServ installs PHP, nginx, MariaDB, etc. via Homebrew. Let's install it first.") {
            ...
            Text("OmniServ v\(state.appVersion) · Emon Khan").font(.caption2).foregroundStyle(.tertiary)
        }
        .padding(36)
